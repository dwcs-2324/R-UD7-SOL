...
<div class="col-md-12 text-right">
        <a href="FrontController.php?controller=Reserva&action=list" class="btn btn-secondary btn-lg">Volver a lista de reservas</a>
        <hr/>
    </div>
<div class="row">
    <?php
...
<!-- reserva -->
      ...
      <div class="mb-3">
        ...
        <input type="tel" class="form-control" id="tel" placeholder="986000111"  pattern="^[69]\d{8}$" required name="tel" title="El número de teléfono debe comenzar por 6 o 9 y debe contener 9 dígitos">
      </div>
